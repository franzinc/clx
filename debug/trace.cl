...
;; 7feb91 -- jdi
;;
;; Unfortunately, the trace-write-hook only runs when a display-force-output
;; is done.  This means that the "process" recorded for a request is the
;; process that did the force-output, which isn't necessarily the process
;; that made the request.  Sigh.
;; 5oct91 -- jdi
